...
public class TravelEachRecommendController {
	...
	public String searchKeyword(@RequestParam(value = "page", defaultValue = "1") int page,
									@RequestParam(value = "contentTypeId", defaultValue = "14") int contentTypeId,
									@RequestParam(value = "contentTypeId", defaultValue = "") String keyword, Model model) 
