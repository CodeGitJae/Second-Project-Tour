	...
	<div class="pagination">      <!-- 서울 지역 페이지 네이션 구현 / 지역벌 페이지는 ajax로 구현함-->
		<nav aria-label="Page navigation example">
		  <ul class="pagination">
		    ...
		    <li class="page-item"><a class="page-link" href="/category/travel?contentTypeId=${recommendTour[0].contenttypeid}&page=${prevPage}">이전</a></li>
	    	...
	    	<li class="page-item"><a class="page-link" href="/category/travel?contentTypeId=${recommendTour[0].contenttypeid}&page=${nextPage}">다음</a></li>
