...
//	e.preventDefault();
	...
	const getKeyword = getUrlParams.get("serach");
	const getContentTypeId = getUrlParams.get("contentTypeId");
	...
	let item = {keyword : getKeyword, contenttypeid : getContentTypeId, cententid : getContentId, img : imgSrc, title : titleText}
